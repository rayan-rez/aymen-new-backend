...
class ProjectInquiryController {
   ...
   * Get new inquiries
   *
   * @route GET /api/v1/inquiries/new
   * @access Private (Admin/Sales)
   */
  getNewInquiries = asyncHandler(
    async (req: Request, res: Response): Promise<void> => {
      ...
      ApiResponse.success(
        res,
        inquiries,
        "New inquiries retrieved successfully"
      );
    }
  );
   ...
   * Get qualified leads
   *
   * @route GET /api/v1/inquiries/qualified
   * @access Private (Admin/Sales)
   */
  getQualifiedLeads = asyncHandler(
    async (req: Request, res: Response): Promise<void> => {
   ...
   *
   * @route GET /api/v1/inquiries/pipeline
   * @access Private (Admin/Sales Manager)
   */
  getPipelineMetrics = asyncHandler(
    async (req: Request, res: Response): Promise<void> => {
   ...
   *
   * @route GET /api/v1/inquiries/project/:projectId
   * @access Private (Admin/Sales)
   */
  getInquiriesByProject = asyncHandler(
    async (req: Request, res: Response): Promise<void> => {
      const { projectId } = req.params;

      const inquiries = await ProjectInquiryModel.getByProject(
        Number(projectId)
      );
   ...
   *
   * @route GET /api/v1/inquiries/financing/:method
   * @access Private (Admin/Sales)
   */
  getInquiriesByFinancing = asyncHandler(
    async (req: Request, res: Response): Promise<void> => {
   ...
   *
   * @route GET /api/v1/inquiries/timeline/:timeline
   * @access Private (Admin/Sales)
   */
  getInquiriesByTimeline = asyncHandler(
    async (req: Request, res: Response): Promise<void> => {
