...
class ContactController {
   ...
   *
   * @route GET /api/v1/contacts/new
   * @access Private (Admin)
   */
  getNewContacts = asyncHandler(
    async (req: Request, res: Response): Promise<void> => {
   ...
   * @access Private (Admin)
   */
  updateContactStatus = asyncHandler(
    async (req: Request, res: Response): Promise<void> => {
      const { id } = req.params;
   ...
   * @access Private (Admin)
   */
  getContactStatistics = asyncHandler(
    async (req: Request, res: Response): Promise<void> => {
   ...
   *
   * @route POST /api/v1/contacts/popup
   * @access Public
   */
  submitPopupContact = asyncHandler(
    async (req: Request, res: Response): Promise<void> => {
      const {
        firstName,
        lastName,
