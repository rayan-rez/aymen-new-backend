 ...
 */
export interface UpdateFloorPlanDto extends Partial<Omit<CreateFloorPlanDto, "plannableType" | "plannableId">> {}
...
> {
  ...
  /**
   * Before create hook - validates floor plan data
   */
  ...
  async duplicateFloorPlans(
    ...
    return this.bulkCreate(targetType, targetId, planData, trx);
  }
